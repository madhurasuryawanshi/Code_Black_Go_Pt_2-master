# tag::init_value[]
from code.dlgo.networks.alphago import alphago_model
from code.dlgo.encoders.alphago import AlphaGoEncoder
from code.dlgo.rl import ValueAgent, load_experience
import h5py
